...
Thus we find that the Harnack inequality gives in Theorem \ref{thm:harnack} is only ``sharp to first order''. The lack of a sharp Harnack is perhaps not too surprising given that the shrinking spheres are flowing by conformal transformation and not a true symmetry for our curvature flows.
