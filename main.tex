...
where \(M_c\) is the simply connected space form of constant sectional curvature \(c\), and $f\in C^{\8}(\G_+)$ is a strictly monotone, 1-homogeneous, symmetric function on the eigenvalues of Weingarten map \(\mathcal{W}\) (principal curvatures) \(\kappa_1, \cdots, \kappa_n\).
 Our principal result is Harnack inequalities for flows on the sphere when the speed $\p(f)=f$ is convex, or $\p(H)=H^{p}$ with $ p\in (0,1)$. This result extends the Harnack inequalities obtained in \cite{BryanIvaki:08/2015, BryanLouie:02/2015} on the sphere. %Along the way, we obtain old Harnack inequalities in Euclidean space \cite{Andrews:09/1994, Chow:06/1991, Hamilton:/1995, MR2813400, Smocyzk:/1997}. Our main results are given in the following theorems.
